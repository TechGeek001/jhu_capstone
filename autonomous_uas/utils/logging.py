...
class LogManagerSingleton:
    ...
    def _get_file_handler(log_file: pathlib.Path) -> RotatingFileHandler:
        ...
        log_file : pathlib.Path
            The path of the JSON log file.

        Returns
        -------
        logging.handlers.RotatingFileHandler
            The RotatingFileHandler that manages logging to a file.
        """
    ...
    def _get_console_handler() -> logging.StreamHandler:
        ...
        logging.StreamHandler
            The StreamHandler that outputs logs to the console.
        """
    ...
    def _setup_exception_handling(logger: logging.Logger):
        ...
        logger : logging.Logger
            The logging object to configure.
        """
...
def get_logger(logger_name: str) -> logging.Logger:
    ...
    -------
    logging.Logger
        The Logger object, as a child of the root logger.
    """
    full_name = f"{LogManager.LOGGER_NAME}.{logger_name}"
    LogManager.parent_logger.info(f"Creating logger: {full_name}")
