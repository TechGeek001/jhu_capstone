...
git remote add -f origin git@github.com:JH-UAS-Capstone/Capstone.git
...
echo 'environment/README.md' >> .git/info/sparse-checkout
echo 'environment/UbuntuDesktopX86-64/setup' >> .git/info/sparse-checkout
