...
def start_testbed_monitor(args: argparse.Namespace):
    ...
    m.attack_manager.add_test("static_gps_spoofer", time_window=(5, 15))
    m.attack_manager.add_test("static_gps_spoofer", time_window=(20, 30))
    m.attack_manager.add_test("static_gps_spoofer", time_window=(35, 40))

    m.attack_manager.add_test("gps_jammer", time_window=(5, 15))
    m.attack_manager.add_test("gps_jammer", time_window=(20, 30))
    m.attack_manager.add_test("gps_jammer", time_window=(35, 40))
